...
describe("sessionPermissionRequest", () => {
  test("prefers the current session permission", () => {
    ...
    expect(sessionPermissionRequest(sessions, permissions, "root")?.id).toBe(
      "perm-root",
    );
  });
  ...
  test("returns undefined without a matching tree permission", () => {
    ...
    expect(
      sessionPermissionRequest(sessions, permissions, "root"),
    ).toBeUndefined();
  });
  ...
  test("returns undefined without a session id", () => {
    ...
    expect(
      sessionPermissionRequest(sessions, permissions, undefined),
    ).toBeUndefined();
  });
  ...
  test("returns undefined when all tree permissions are filtered out", () => {
    ...
    expect(
      sessionPermissionRequest(sessions, permissions, "root", () => false),
    ).toBeUndefined();
  });
});
...
describe("sessionQuestionRequest", () => {
  test("prefers the current session question", () => {
    ...
    expect(sessionQuestionRequest(sessions, questions, "root")?.id).toBe(
      "q-root",
    );
  });
