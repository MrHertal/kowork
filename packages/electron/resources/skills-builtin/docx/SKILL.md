...
user's folder** — so nothing is left sitting beside their document.

1. Copy `scripts/create_docx.cjs` into your platform's temp directory and edit
   the copy's `children` array to build the requested content.
