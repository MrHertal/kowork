...
const api: ElectronAPI = {
  ...
  opencodeConfigPatch: (pointer, value) =>
    ipcRenderer.invoke("opencode-config-patch", pointer, value),
  managedSkillsDir: () => ipcRenderer.invoke("managed-skills-dir"),
  installBundledSkill: (id) => ipcRenderer.invoke("install-bundled-skill", id),
  uninstallBundledSkill: (id) =>
    ipcRenderer.invoke("uninstall-bundled-skill", id),
};
